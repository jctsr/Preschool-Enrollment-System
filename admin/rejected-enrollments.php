...
$query = "SELECT * FROM tblenrollment WHERE enrollStatus = 'Rejected'";
    ...
    <div class="container-fluid">
      ...
      <div class="row pt-5 pb-3 d-flex justify-content-between">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item breadcrumb-dashboard active" aria-current="page">Rejected Enrollments</li>
        </ol>
        </div>
      </div>
