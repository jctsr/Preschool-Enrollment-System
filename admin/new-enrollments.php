...
$query = "SELECT * FROM tblenrollment WHERE (enrollStatus is NULL || enrollStatus = '')";
    ...
    <div class="container-fluid">
       ...
       <div class="row pt-5 pb-3 d-flex justify-content-between">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item breadcrumb-dashboard active" aria-current="page">New Enrollments</li>
        </ol>
        </div>
      </div>
