...
$query = "SELECT * FROM tblvisitor WHERE status = 'Not-Visited'";
    ...
    <div class="container-fluid">
      ...
      <div class="row pt-5 pb-3 d-flex justify-content-between">
        ...
        <div class="col-9 col-md-4 d-flex justify-content-end">
          ...
          <li class="breadcrumb-item breadcrumb-dashboard active" aria-current="page">Not Visited Visitors</li>
          </ol>
        </div>
      </div>
                   ...
                   <?php foreach ($rows as $row) {?>
                    <tr>
                      ...
                      <th class="text-center">
                        <a href="visitor-details.php?vid=<?=htmlspecialchars($row['id'])?>" title="View Details" class="btn btn-primary">View Details</a>
                      </th>
                    </tr>
                    <?php }?>
