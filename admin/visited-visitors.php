...
$query = "SELECT * FROM tblvisitor WHERE status = 'Visited'";
    ...
    <div class="container-fluid">
      ...
      <div class="row pt-5 pb-3 d-flex justify-content-between">
        ...
        <div class="col-9 col-md-4 d-flex justify-content-end">
          ...
          <li class="breadcrumb-item breadcrumb-dashboard active" aria-current="page">Visited Visitors</li>
          </ol>
        </div>
      </div>
