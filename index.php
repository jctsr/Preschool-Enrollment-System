...
# select data from db & display classes
$query = "SELECT tblteachers.fullName, tblteachers.teacherSubject, tblteachers.teacherPic, tblclasses.*, tblclasses.id AS classid FROM tblclasses
...
<!-- carousel -->
<?php include './homepage/carousel.php' ?>

<!-- school facilities -->
<?php include './homepage/facilities.php' ?>

<!-- school classes -->
<?php include './classpage/classes.php' ?>

<!-- visit form -->
<?php include './visitpage/visit-form.php' ?>

<!-- teachers -->
<?php include './homepage/teachers.php' ?>
